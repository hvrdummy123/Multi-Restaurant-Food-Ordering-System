...
public class UserController {
    ...
    public ResponseEntity<UserPreference> setUserPreferences(@PathVariable Long id, @RequestBody UserPreference preferredCuisine) {
        try {
    ...
    public ResponseEntity<UserPreference> updateUserPreferences(@PathVariable Long id, @RequestBody UserPreference preferredCuisine) {
        try {
